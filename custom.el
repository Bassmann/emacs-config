(custom-set-variables
 ...
 '(auto-save-file-name-transforms '((".*" "~/.emacs.d/data/auto-save/\\1" t)))
 '(beacon-color "#cc6666")
 ...
 '(package-selected-packages
   '(ls-lisp all-the-icons-ivy all-the-icons-dired ivy-rich counsel doom-themes ivy org2jekyll mode-icons helm el-get org-wiki ibuffer-sidebar dired-sidebar golden-ratio-scroll-screen org-beautify-theme org-beautify toc-org comment-dwim-2 rainbow-mode ace-window which-key todotxt-mode org-cliplink link-hint default-text-scale dashboard rainbow-delimiters diminish auto-revert htmlize uniquify plantuml-mode deft ox-pandoc ac-html ac-html-bootstrap company-web zenburn-theme undo-tree scss-mode request powershell-mode powershell php-extras org-bullets org-ac markdown-mode less-css-mode js2-mode ido-ubiquitous hl-line+ hc-zenburn-theme flycheck feature-mode f exec-path-from-shell esxml dired-details company))
...
(custom-set-faces
 ...
 '(org-document-title ((t (:inherit default :weight bold :foreground "#fdf4c1" :font "Verdana" :height 2.0 :underline nil))))
 '(org-headline-done ((t (:foreground "dim gray" :strike-through t))))
 '(org-level-1 ((t (:inherit variable-pitch :foreground "#cb4b16" :box nil :weight bold :height 1.3))))
 '(org-level-2 ((t (:inherit variable-pitch :foreground "#859900" :box nil :height 1.2))))
 '(org-level-3 ((t (:inherit default :weight bold :foreground "#fdf4c1" :font "Verdana" :height 1.25))))
 '(org-level-4 ((t (:inherit default :weight bold :foreground "#fdf4c1" :font "Verdana" :height 1.1))))
 '(org-level-5 ((t (:inherit default :weight bold :foreground "#fdf4c1" :font "Verdana"))))
 '(org-level-6 ((t (:inherit default :weight bold :foreground "#fdf4c1" :font "Verdana"))))
 '(org-level-7 ((t (:inherit default :weight bold :foreground "#fdf4c1" :font "Verdana"))))
 '(org-level-8 ((t (:inherit default :weight bold :foreground "#fdf4c1" :font "Verdana"))))
